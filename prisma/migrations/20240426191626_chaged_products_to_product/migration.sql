...
*/
-- DropIndex
DROP INDEX "Products_departamentId_key";
...
CREATE TABLE "Product" (
    ...
    "description" TEXT,
    "color" TEXT NOT NULL,
    CONSTRAINT "Product_departamentId_fkey" FOREIGN KEY ("departamentId") REFERENCES "Departaments" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_departamentId_key" ON "Product"("departamentId");
